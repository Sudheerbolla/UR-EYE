...
public final class ObjectDetectionActivity extends AppCompatActivity implements OnRequestPermissionsResultCallback {
    ...
    private static CustomObjectDetectorOptions getCustomObjectDetectorOptions(Context context, LocalModel localModel, @ObjectDetectorOptionsBase.DetectorMode int mode) {
        SharedPreferences sharedPreferences = PreferenceManager.getDefaultSharedPreferences(context);

        boolean enableMultipleObjects = sharedPreferences.getBoolean("lpodemo", false);
        boolean enableClassification = sharedPreferences.getBoolean("lpodec", true);
    ...
    private void createThenStartCameraXSource() {
        ...
        customObjectDetectorOptions = getCustomObjectDetectorOptions(getApplicationContext(), localModel, CustomObjectDetectorOptions.STREAM_MODE);
