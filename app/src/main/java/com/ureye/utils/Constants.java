...
public class Constants {
    ...
    public static final String[] OBJECT_DETECTION_KEYWORDS = new String[]{"one", "1", "object", "motion"};
    public static final String[] TEXT_DETECTION_KEYWORDS = new String[]{"two", "2", "text", "label", "heading"};
    public static final String[] FACE_DETECTION_KEYWORDS = new String[]{"three", "3", "face", "friends", "people"};
