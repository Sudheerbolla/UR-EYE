...
package com.ureye.utils.objectdetector;
...
public class ObjectGraphic extends GraphicOverlay.Graphic {
    ...
    public void draw(Canvas canvas) {
        ...
        int colorID = object.getTrackingId() == null ? 0 : Math.abs(object.getTrackingId() % NUM_COLORS);
...
//            textWidth = Math.max(textWidth, textPaints[colorID].measureText(String.format(Locale.US, LABEL_FORMAT, label.getConfidence() * 100, label.getIndex())));
